...
\PY{c+c1}{\PYZsh{}plot\PYZus{}data(data\PYZus{}df, temperature=True, CO2=True, PIR=True, light=True)}

\PY{c+c1}{\PYZsh{}scatter\PYZus{}plot(data\PYZus{}df, temperature=False, C02\PYZus{}PIR=False, light=False)}
\end{Verbatim}
\end{tcolorbox}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Normalize data with MinMaxScaler}
\end{Verbatim}
\end{tcolorbox}

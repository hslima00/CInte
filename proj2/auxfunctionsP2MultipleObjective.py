...
def MO_evaluatecostfixed(individual, CustDist, CustOrd_list):
    total_distance = 0 
    load = 1000 
    total_cost = 0    
    ...
    for i in range(len(individual)):
        ...
        if(load < 50):
            ...
            # calcula o custo de ir à central com o camião com a current load 
            ...
            # calcula o custo de ir da central para o próximo cliente (custo = carga * distância)
            total_cost = total_cost + load * CustDist[0][individual[i-1]]
            load = load - 50
